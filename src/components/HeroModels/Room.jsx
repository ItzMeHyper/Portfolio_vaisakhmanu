...
export function Room(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      {/* Wall 3D Text: */}
      <Text
        position={[0, 4.3, -2.9]} // adjust to your wall's position
        fontSize={0.5}
        color="#8338ec"
        anchorX="center"
        anchorY="middle"
...
{/* Welcome Text on the Floor (Laying Flat): */}
<Text
        position={[2, 0.3, 3]} // adjust to the floor's position
        fontSize={0.3}
        color="#00BFFF"
        anchorX="center"
        anchorY="middle"
        ...
        outlineBlur={0.2}
        outlineWidth={0.05}
        rotation={[-Math.PI / 2, 0, 0]} // Rotate the text to lay flat on the floor
      >
       welcome!
      </Text>
      <mesh
